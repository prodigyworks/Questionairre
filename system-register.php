...
<div class="registerPage">
	...
	<form id="loginForm" enctype="multipart/form-data" name="loginForm" class="entryform manualform" method="post" action="system-register-redemption.php">
	  <table border="0" cellspacing=5 align="left">
	    ...
	    <tr>
	      ...
	      <td>
	      	<SELECT id="membershiptype" name="membershiptype">
	      		<OPTION value="N">NHS User</OPTION>
	      		<OPTION value="P">Public User</OPTION>
	      	</SELECT>
	      </td>
	    </tr>
	    <tr>
	      <td>Address</td>
	      <td><input required="true" name="address1" type="text" class="textfield" id="address1" /></td>
	    </tr>
	    <tr>
	      <td>City</td>
	      <td><input required="true" name="city" type="text" class="textfield" id="city" /></td>
	    </tr>
	    <tr>
	      <td>County</td>
	      <td><input required="true" name="county" type="text" class="textfield" id="county" /></td>
	    </tr>
	    <tr>
	      <td>Post Code</td>
	      <td><input required="true" name="postcode" type="text" id="postcode" /></td>
	    </tr>
	    <tr>
	      <td>Country</td>
	      <td><input required="true" name="country" type="text" class="textfield" id="country" /></td>
	    </tr>
	    <tr>
	      <td>Email</td>
	    ...
	    <tr>
	      ...
	      <td>
	      	<input name="redemptioncode" type="text" style='width:100px' id="redemptioncode" />
	      </td>
	    </tr>
	    <tr>
	      <td>&nbsp;</td>
	      <td>
	      	<br>
	  		<span class="wrapper"><a class='link1' href="javascript:if (verify()) submitForm();"><em><b>Process</b></em></a></span>
	      </td>
	    </tr>
	  </table>
...
<script>
	...
	function submitForm() {
		if ($("#redemptioncode").val() != "") {
			$("#loginForm").attr("action", "system-register-redemption.php");

		} else {
			$("#loginForm").attr("action", "system-register-paypal.php");
		}
