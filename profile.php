...
?>
	<form id="loginForm" class="manualform" enctype="multipart/form-data" name="loginForm" method="post" action="system-register-update.php?id=<?php echo $memberid; ?>">
	  <table border="0" align="left" width='100%'>
	    ...
	    <tr>
	      <td>Address</td>
	      <td><input required="true" name="address1" type="text" class="textfield" id="address1" value="<?php echo $member['address1']; ?>"  /></td>
	    </tr>
	    <tr>
	      <td>City</td>
	      <td><input required="true" name="city" type="text" class="textfield" id="city" value="<?php echo $member['city']; ?>"  /></td>
	    </tr>
	    <tr>
	      <td>County</td>
	      <td><input required="true" name="county" type="text" class="textfield" id="county" value="<?php echo $member['county']; ?>" /></td>
	    </tr>
	    <tr>
	      <td>Post Code</td>
	      <td><input required="true" name="postcode" type="text" id="postcode" value="<?php echo $member['postcode']; ?>" /></td>
	    </tr>
	    <tr>
	      <td>Country</td>
	      <td><input required="true" name="country" type="text" class="textfield" id="country" value="<?php echo $member['country']; ?>" /></td>
	    </tr>
	    <tr>
	      <td>Email</td>
	      <td>
