<?php
	...
	function regenerate() {
		...
		$signatureemail_jc = getSiteConfigData()->signatureemail . "Please follow the link below and log in using your unique credentials.<br /><br />Web address: http://optiks.inter-cloud.co.uk<br>Login : " . $theloginjc . "<br>Password : " . $thepasswordjc."<br><br><strong>Loan period extended</strong><br><br>The loan period for the item you already have in your possession is being extended and we will forward you a copy of the revised contract.<br><br>";
